...
sub meta_merge {
	...
	resources	=> {
	    ...
	    repository	=> {
		type	=> 'git',
		url	=> 'git://github.com/trwyant/perl-Test-Prereq-Meta.git',
		web	=> 'https://github.com/trwyant/perl-Test-Prereq-Meta',
	    },
	},
	@extra,
    };
...
My::Module::Meta - Information needed to build Test::Prereq::Meta
...
This module centralizes information needed to build C<Test::Prereq::Meta>. It
is private to the C<Test::Prereq::Meta> package, and may be changed or
...
the modules required to run the C<Test::Prereq::Meta>
...
Copyright (C) 2021-2022, 2025-2026 by Thomas R. Wyant, III
